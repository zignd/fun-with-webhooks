...
import {
	Form, FormGroup, Label, Button, ButtonGroup, Col, Row, Input, Card, CardImg, CardText, CardBody,
...
{/* <div>
	<Row>
		<Col>
			<Label sm={2}>Id</Label>
			<Col sm={10}>
				<Input type="text" value={this.state.limit} onChange={(a) => this.setState({ limit: a })} />
			</Col>
		</Col>
		<div className="col">
			<label>Id:</label><span>{call.number}</span>
		</div>
		<div className="col">
			<span>Number:</span><span>{call.number}</span>
		</div>
	</Row>
</div> */}